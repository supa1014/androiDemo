 ...
 * Original file: D:\\mwqi\\workspace\\heima52\\mobilesafe54\\src\\com\\android\\internal\\telephony\\ITelephony.aidl
 */
...
case TRANSACTION_transmitIccBasicChannel:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
java.lang.String _result = this.transmitIccBasicChannel(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5);
reply.writeNoException();
reply.writeString(_result);
return true;
}
...
int _arg0;
_arg0 = data.readInt();
boolean _result = this.closeIccLogicalChannel(_arg0);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _result = this.getATR();
reply.writeNoException();
reply.writeString(_result);
return true;
}
...
/**
    ...
    */
@Override public java.lang.String transmitIccBasicChannel(int cla, int command, int p1, int p2, int p3, java.lang.String data) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
_data.writeInt(p3);
_data.writeString(data);
mRemote.transact(Stub.TRANSACTION_transmitIccBasicChannel, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
/**
    ...
    */
@Override public boolean closeIccLogicalChannel(int channel) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
    ...
    */
@Override public int getLastError() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
/**
    ...
    */
@Override public java.lang.String getATR() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
static final int TRANSACTION_transmitIccBasicChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
...
static final int TRANSACTION_getLastError = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_getATR = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
}
/**
     * Dial a number. This doesn't place the call. It displays
     * the Dialer screen.
...
/**
    * Returns the response APDU for a command APDU sent to the basic channel
    */
public java.lang.String transmitIccBasicChannel(int cla, int command, int p1, int p2, int p3, java.lang.String data) throws android.os.RemoteException;
/**
    * Returns the channel id of the logical channel,
    * Returns 0 on error.
    */
...
/**
    * Returns the Answer to Reset of the current active SIM card.
    */
public java.lang.String getATR() throws android.os.RemoteException;
}
